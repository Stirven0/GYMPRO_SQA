...
Repositorio de documentación SQA para el proyecto **GymPro** (`https://gestion-gympro.up.railway.app`).
...
Ver `AGENTS.md` para convenciones del proyecto y credenciales de prueba.
